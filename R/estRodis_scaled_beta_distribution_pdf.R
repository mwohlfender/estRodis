...
#' determined by the parameters `alpha` and `beta` and defined on the open interval  `p`, `q` at `x`.
#'
...
#'
#' @details Values of `x` outside the open interval `p`, `q` are evaluated to `0`.
#'
