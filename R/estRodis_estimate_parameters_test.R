...
#' @title Estimate parameters using Model Test
#'
#' @description `estRodis_estimate_parameters_test()` estimates the effective reproduction number,
...
#'
#' @details The core of the function `estRodis_estimate_parameters_test()` is a mathematical model
...
estRodis_estimate_parameters_test <- function(clusters_size,
                                              clusters_freq,
                                              prior_r = c(10, 10),
                                              prior_k = c(5, 10),
  ...
  out <- rstan::sampling(object = stanmodels$estRodis_stan_model_estimate_parameters_test,
                         data = standata,
                         pars = pars,
                         chains = chains,
                         iter = iter,
