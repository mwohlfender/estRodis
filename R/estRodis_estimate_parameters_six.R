...
#' @title Estimate parameters using Model 6
#'
#' @description `estRodis_estimate_parameters_six()` estimates the effective reproduction number and
...
#'
#' @details The core of the function `estRodis_estimate_parameters_six()` is a mathematical model
...
estRodis_estimate_parameters_six <- function(clusters_size,
                                             clusters_freq,
                                             prior_r = c(10, 10),
                                             prior_k = c(5, 10),
  ...
  out <- rstan::sampling(object = stanmodels$estRodis_stan_model_estimate_parameters_six,
                         data = standata,
                         pars = pars,
                         chains = chains,
                         iter = iter,
