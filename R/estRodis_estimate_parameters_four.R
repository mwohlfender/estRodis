...
#' @title Estimate parameters using Model 4
#'
#' @description `estRodis_estimate_parameters_four()` estimates the effective reproduction number and
...
#'
#' @details The core of the function `estRodis_estimate_parameters_four()` is a mathematical model
...
#' The effective reproduction number and the dispersion parameter are included into the model with prior distributions.
...
estRodis_estimate_parameters_four <- function(clusters_size,
                                              clusters_freq,
                                              prior_r = c(10, 10),
                                              prior_k = c(5, 10),
  ...
  out <- rstan::sampling(object = stanmodels$estRodis_stan_model_estimate_parameters_four,
                         data = standata,
                         pars = pars,
                         chains = chains,
                         iter = iter,
