...
#' @title Estimate parameters using Model 5
#'
#' @description `estRodis_estimate_parameters_five()` estimates the effective reproduction number,
...
#' @param prior_mutation Shape parameters for the prior distribution (beta) of the mutation probability.
...
#'
#' @details The core of the function `estRodis_estimate_parameters_five()` is a mathematical model
...
#' The effective reproduction number, the dispersion parameter, the mutation probability
#' and the testing probability are included into the model with prior distributions.
#' The sequencing probability is included into the model as fixed parameter.
...
estRodis_estimate_parameters_five <- function(clusters_size,
                                              clusters_freq,
                                              prior_r = c(10, 10),
                                              prior_k = c(5, 10),
  ...
  out <- rstan::sampling(object = stanmodels$estRodis_stan_model_estimate_parameters_five,
                         data = standata,
                         pars = pars,
                         chains = chains,
                         iter = iter,
