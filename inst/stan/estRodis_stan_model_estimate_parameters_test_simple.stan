...
#include "/stan_functions/estRodis_stan_functions_estimate_parameters_test.stan"
...
model {
  ...
  // likelihood
  target += estRodis_stan_likelihood_log_inf_improved(clusters_size, clusters_freq, 2500, R, k, mutation_proba, detection_proba);
}
