...
#include "stanExports_stan_model_R_k_testing_v1_a.h"

RCPP_MODULE(stan_fit4stan_model_R_k_testing_v1_a_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_stan_model_R_k_testing_v1_a")
