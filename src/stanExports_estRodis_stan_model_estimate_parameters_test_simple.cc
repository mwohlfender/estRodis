...
#include "stanExports_estRodis_stan_model_estimate_parameters_test_simple.h"

RCPP_MODULE(stan_fit4estRodis_stan_model_estimate_parameters_test_simple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_estRodis_stan_model_estimate_parameters_test_simple")
