...
namespace model_estRodis_stan_model_estimate_parameters_five_namespace {
...
static constexpr std::array<const char*, 85> locations_array__ =
  ...
  " (in 'string', line 178, column 2 to column 46)",
  " (in 'string', line 179, column 2 to column 75)",
  " (in 'string', line 182, column 2 to column 58)",
  " (in 'string', line 187, column 2 to column 36)",
  " (in 'string', line 189, column 2 to column 36)",
  " (in 'string', line 191, column 2 to column 62)",
  " (in 'string', line 193, column 2 to column 116)",
  " (in 'string', line 195, column 2 to column 110)",
  ...
  " (in 'string', line 168, column 2 to column 25)",
...
class model_estRodis_stan_model_estimate_parameters_five final : public 
 model_base_crtp<model_estRodis_stan_model_estimate_parameters_five> {
private:
  int M;
  ...
  std::vector<double> prior_mutation;
  std::vector<double> prior_testing;
  double sequencing_proba;
public:
  ~model_estRodis_stan_model_estimate_parameters_five() {}
  model_estRodis_stan_model_estimate_parameters_five(stan::io::var_context&
    ...
    static constexpr const char* function__ =
      "model_estRodis_stan_model_estimate_parameters_five_namespace::model_estRodis_stan_model_estimate_parameters_five";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      context__.validate_dims("data initialization", "prior_mutation",
        "double", std::vector<size_t>{static_cast<size_t>(2)});
      prior_mutation = std::vector<double>(2,
                         std::numeric_limits<double>::quiet_NaN());
      current_statement__ = 18;
      prior_mutation = context__.vals_r("prior_mutation");
  ...
  inline std::string model_name() const final {
    return "model_estRodis_stan_model_estimate_parameters_five";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_estRodis_stan_model_estimate_parameters_five_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      mutation_proba = in__.template read_constrain_lub<local_scalar_t__,
                         jacobian__>(0, 1, lp__);
      ...
      detection_proba = (testing_proba * sequencing_proba);
      {
        ...
        lp_accum__.add(stan::math::beta_lpdf<propto__>(mutation_proba,
                         stan::model::rvalue(prior_mutation,
                           "prior_mutation", stan::model::index_uni(1)),
                         stan::model::rvalue(prior_mutation,
                           "prior_mutation", stan::model::index_uni(2))));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_estRodis_stan_model_estimate_parameters_five_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      local_scalar_t__ mutation_proba = DUMMY_VAR__;
      current_statement__ = 3;
      mutation_proba = in__.read<local_scalar_t__>();
      out__.write_free_lub(0, 1, mutation_proba);
      local_scalar_t__ testing_proba = DUMMY_VAR__;
      current_statement__ = 4;
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      context__.validate_dims("parameter initialization", "k", "double",
        std::vector<size_t>{});
      current_statement__ = 3;
      context__.validate_dims("parameter initialization", "mutation_proba",
        "double", std::vector<size_t>{});
      current_statement__ = 4;
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"R", "k", "mutation_proba",
                "testing_proba"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"R\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"k\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mutation_proba\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"testing_proba\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"detection_proba\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_estRodis_stan_model_estimate_parameters_five_namespace::model_estRodis_stan_model_estimate_parameters_five;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_estRodis_stan_model_estimate_parameters_five_namespace::profiles__;
}
#endif
#endif
