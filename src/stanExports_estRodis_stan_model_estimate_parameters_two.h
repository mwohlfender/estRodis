...
namespace model_estRodis_stan_model_estimate_parameters_two_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 177, column 2 to column 45)",
                                                      " (in 'string', line 180, column 2 to column 95)",
                                                      " (in 'string', line 185, column 2 to column 36)",
                                                      " (in 'string', line 187, column 2 to column 36)",
                                                      " (in 'string', line 189, column 2 to column 103)",
...
class model_estRodis_stan_model_estimate_parameters_two final : public model_base_crtp<model_estRodis_stan_model_estimate_parameters_two> {
private:
  int M;
...
public:
  ~model_estRodis_stan_model_estimate_parameters_two() { }
  
  inline std::string model_name() const final { return "model_estRodis_stan_model_estimate_parameters_two"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_estRodis_stan_model_estimate_parameters_two(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_estRodis_stan_model_estimate_parameters_two_namespace::model_estRodis_stan_model_estimate_parameters_two";
    ...
    try {
      ...
      context__.validate_dims("data initialization","detection_proba",
          "double",context__.to_vec());
      detection_proba = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 18;
      detection_proba = context__.vals_r("detection_proba")[(1 - 1)];
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_estRodis_stan_model_estimate_parameters_two_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_estRodis_stan_model_estimate_parameters_two_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"R\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"k\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"number_yearly_mutations\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mutation_proba\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_estRodis_stan_model_estimate_parameters_two_namespace::model_estRodis_stan_model_estimate_parameters_two;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_estRodis_stan_model_estimate_parameters_two_namespace::profiles__;
}
#endif
#endif
