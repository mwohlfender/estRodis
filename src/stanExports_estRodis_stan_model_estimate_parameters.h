...
namespace model_estRodis_stan_model_estimate_parameters_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 118, column 2 to column 75)",
                                                      " (in 'string', line 121, column 2 to column 95)",
                                                      " (in 'string', line 122, column 2 to column 58)",
                                                      " (in 'string', line 127, column 2 to column 35)",
                                                      " (in 'string', line 129, column 2 to column 35)",
                                                      " (in 'string', line 131, column 2 to column 103)",
                                                      " (in 'string', line 133, column 2 to column 116)",
                                                      " (in 'string', line 135, column 2 to column 110)",
                                                      " (in 'string', line 95, column 2 to column 22)",
                                                      " (in 'string', line 97, column 20 to column 21)",
                                                      " (in 'string', line 97, column 2 to column 23)",
                                                      " (in 'string', line 99, column 20 to column 21)",
                                                      " (in 'string', line 99, column 2 to column 23)",
                                                      " (in 'string', line 101, column 2 to column 18)",
                                                      " (in 'string', line 103, column 2 to column 18)",
                                                      " (in 'string', line 105, column 2 to column 32)",
                                                      " (in 'string', line 107, column 2 to column 40)",
                                                      ...
                                                      " (in 'string', line 6, column 78 to line 12, column 3)",
                                                      ...
                                                      " (in 'string', line 13, column 53 to line 21, column 3)",
                                                      " (in 'string', line 29, column 4 to column 54)",
                                                      " (in 'string', line 31, column 4 to column 167)",
                                                      ...
                                                      " (in 'string', line 57, column 62 to line 60, column 5)",
                                                      " (in 'string', line 57, column 4 to line 60, column 5)",
                                                      " (in 'string', line 65, column 6 to column 49)",
                                                      " (in 'string', line 67, column 6 to column 57)",
                                                      " (in 'string', line 69, column 65 to column 106)",
                                                      " (in 'string', line 69, column 6 to column 106)",
                                                      " (in 'string', line 71, column 65 to column 149)",
                                                      " (in 'string', line 71, column 6 to column 149)",
                                                      " (in 'string', line 72, column 6 to column 81)",
                                                      " (in 'string', line 74, column 6 to line 81, column 7)",
                                                      " (in 'string', line 76, column 8 to column 88)",
                                                      " (in 'string', line 77, column 68 to column 242)",
                                                      " (in 'string', line 77, column 8 to column 242)",
                                                      " (in 'string', line 79, column 8 to column 143)",
                                                      " (in 'string', line 80, column 8 to column 19)",
                                                      " (in 'string', line 83, column 6 to column 119)",
                                                      " (in 'string', line 85, column 36 to column 188)",
                                                      " (in 'string', line 85, column 6 to column 188)",
                                                      " (in 'string', line 63, column 11 to line 86, column 5)",
                                                      " (in 'string', line 62, column 36 to column 122)",
                                                      " (in 'string', line 62, column 6 to column 122)",
                                                      " (in 'string', line 61, column 32 to line 63, column 5)",
                                                      " (in 'string', line 61, column 4 to line 86, column 5)",
                                                      " (in 'string', line 88, column 6 to column 90)",
                                                      " (in 'string', line 87, column 34 to line 89, column 5)",
                                                      " (in 'string', line 87, column 4 to line 89, column 5)",
                                                      " (in 'string', line 90, column 4 to column 28)",
                                                      " (in 'string', line 27, column 137 to line 91, column 3)"};
template <bool propto__, typename T0__, typename T1__, typename T2__,
typename T3__, typename T4__>
stan::promote_args_t<T0__, T1__, T2__, T3__,
T4__>
estRodis_stan_scaled_beta_lpdf(const T0__& a, const T1__& b, const T2__& p,
                               const T3__& q, const T4__& x,
...
{
return estRodis_stan_scaled_beta_lpdf<propto__>(a, b, p, q, x, pstream__);
}
};
template <typename T0__>
int
estRodis_stan_determine_scaling_factor(const T0__& x, std::ostream* pstream__) {
  using local_scalar_t__ = stan::promote_args_t<T0__>;
...
struct estRodis_stan_determine_scaling_factor_functor__ {
template <typename T0__>
int
operator()(const T0__& x, std::ostream* pstream__)  const 
{
return estRodis_stan_determine_scaling_factor(x, pstream__);
}
};
...
estRodis_stan_likelihood_log(const std::vector<int>& clusters_size,
  ...
  try {
    ...
    upper_limit_size_identical_sequence_clusters = std::max(
                                                     (estRodis_stan_determine_scaling_factor(
...
class model_estRodis_stan_model_estimate_parameters final : public model_base_crtp<model_estRodis_stan_model_estimate_parameters> {
private:
  int M;
...
public:
  ~model_estRodis_stan_model_estimate_parameters() { }
  
  inline std::string model_name() const final { return "model_estRodis_stan_model_estimate_parameters"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = %%NAME%%3 %%VERSION%%", "stancflags = "};
  }
  
  
  model_estRodis_stan_model_estimate_parameters(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_estRodis_stan_model_estimate_parameters_namespace::model_estRodis_stan_model_estimate_parameters";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_estRodis_stan_model_estimate_parameters_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_estRodis_stan_model_estimate_parameters_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_estRodis_stan_model_estimate_parameters_namespace::model_estRodis_stan_model_estimate_parameters;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_estRodis_stan_model_estimate_parameters_namespace::profiles__;
}
#endif
#endif
